...
proc `/`*(a: bool, b: bool): int =
  if a:
    ...
    raise new_exception(Exception, "Boolean division by 0 is not possible!")
...
proc `/`*(a: int, b: bool): int =
  ...
  raise new_exception(Exception, "Integer division by 0 is not possible!")
...
proc `/`*(a: string, b: bool): string =
  ...
  raise new_exception(Exception, "String division by 0 is not possible!")
...
proc `/`*(a: string, b: float): string =
  if b == 0.0:
    raise new_exception(Exception, "String division by 0.0 is not possible!")
